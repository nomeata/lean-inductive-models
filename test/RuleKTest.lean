...
def main : IO UInt32 := do
  ...
  let simple ← runFixture "test/fixtures/modelgen/prim_shapes.ndjson"
  ...
  let mutualFixture ← runFixture "test/fixtures/modelgen/mutual_prop.ndjson"
  ...
  let nested ← runFixture "test/fixtures/modelgen/nested_iota.ndjson"
