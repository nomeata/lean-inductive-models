...
class FixtureMatrix:
    ...
    def render(self) -> str:
        ...
        exported = [
            ...
            "GeneratedChangedIndexedPublic", "GeneratedChangedIndexedPrivate",
            "generatedChangedIndexedRoll", "generatedChangedIndexedUnroll",
            "generatedChangedIndexedUnrollRoll", "generatedChangedIndexedRollUnroll",
...
inductive GeneratedPair (left right : Type) : Type where
  | pair (first : left) (second : right) : GeneratedPair left right

/- Two source occurrences in one nested field share the container recursor's
single IH binder. `GeneratedMixed` additionally interleaves a direct IH. -/
inductive GeneratedShared : Type where
  | mk (children : GeneratedPair GeneratedShared GeneratedShared) : GeneratedShared
...
axiom generatedChangedDirectRoll :
  GeneratedChangedDirectPublic -> GeneratedChangedDirectPrivate
axiom generatedChangedDirectUnroll :
  GeneratedChangedDirectPrivate -> GeneratedChangedDirectPublic
axiom generatedChangedDirectUnrollRoll (value : GeneratedChangedDirectPublic) :
  generatedChangedDirectUnroll (generatedChangedDirectRoll value) = value
...
inductive GeneratedChangedIndexedPrivate : GeneratedIndex -> Type where
  | mk (index : GeneratedIndex) (child : GeneratedChangedIndexedPrivate index) :
      GeneratedChangedIndexedPrivate index

axiom generatedChangedIndexedRoll (index : GeneratedIndex) :
  GeneratedChangedIndexedPublic index -> GeneratedChangedIndexedPrivate index
axiom generatedChangedIndexedUnroll (index : GeneratedIndex) :
  GeneratedChangedIndexedPrivate index -> GeneratedChangedIndexedPublic index
axiom generatedChangedIndexedUnrollRoll (index : GeneratedIndex)
    (value : GeneratedChangedIndexedPublic index) :
  generatedChangedIndexedUnroll index (generatedChangedIndexedRoll index value) = value
axiom generatedChangedIndexedRollUnroll (index : GeneratedIndex)
    (value : GeneratedChangedIndexedPrivate index) :
...
axiom generatedChangedNestedRoll :
  GeneratedChangedNestedPublic -> GeneratedChangedNestedPrivate
axiom generatedChangedNestedUnroll :
  GeneratedChangedNestedPrivate -> GeneratedChangedNestedPublic
axiom generatedChangedNestedUnrollRoll (value : GeneratedChangedNestedPublic) :
...
identity sibling in the same SCC. -/
mutual
inductive GeneratedLayerA : Type where
  | mk (child : GeneratedLayerB) : GeneratedLayerA
inductive GeneratedLayerB : Type where
  | stop : GeneratedLayerB
  | back (parent : GeneratedLayerA) : GeneratedLayerB
end
"""
