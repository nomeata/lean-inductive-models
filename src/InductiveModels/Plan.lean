...
`test/fixtures/inductive-models/nest_mutual_both.ndjson` and the mutual-container
closure in `test/fixtures/inductive-models/hard_nested_mutual_index.ndjson`.
-/
